export default function BerylliumIcon({ ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={66} height={56} fill="none" {...props}>
      <g fill="currentColor" clipPath="url(#a)">
        <path d="M1 8a7 7 0 0 1 7-7h2v54H8a7 7 0 0 1-7-7V8Z" opacity={0.1} />
        <path
          fillRule="evenodd"
        ...
        <path
          ...
          opacity={0.3}
        />
        <path d="M26 8.5A1.5 1.5 0 0 1 27.5 7h14a1.5 1.5 0 0 1 0 3h-14A1.5 1.5 0 0 1 26 8.5Z" opacity={0.7} />
        <path d="M47 8.5A1.5 1.5 0 0 1 48.5 7h11a1.5 1.5 0 0 1 0 3h-11A1.5 1.5 0 0 1 47 8.5Z" opacity={0.4} />
        <path
