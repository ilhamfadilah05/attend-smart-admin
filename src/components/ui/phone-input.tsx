...
const inputClasses = {
  base: 'block peer !w-full focus:outline-none transition duration-200 disabled:!bg-gray-100 disabled:!text-gray-500 disabled:placeholder:!text-gray-500 disabled:!cursor-not-allowed disabled:!border-gray-200',
  error:
  ...
  variant: {
    ...
    flat: {
      base: '!border-0 focus:ring-2 placeholder:!opacity-90 read-only:focus:!ring-0 focus:!bg-transparent',
      color: {
        DEFAULT:
          '!bg-gray-200/70 focus:!ring-gray-900/20 !text-gray-1000 placeholder:!text-gray-600',
        primary:
        ...
        warning:
          '!bg-orange-lighter/80 focus:!ring-orange/30 !text-orange-dark',
      },
    },
    outline: {
