                    ...
                    {item?.dropdownItems ? (
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          isActive
                            ? "bg-primary text-white before:top-2/5 text-primary before:absolute before:-start-3 before:block before:h-4/5 before:w-1 before:rounded-ee-md before:rounded-se-md before:bg-primary 2xl:before:-start-5"
                      ...
                      >
                        <div className="flex items-center truncate">
                          ...
                          <span
                            className={isActive ? "text-white" : "truncate"}
                          >
                            {item.name}
                          </span>
                        </div>
