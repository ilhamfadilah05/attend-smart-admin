...
export default function Spinner({ tag = "div", size = "DEFAULT", color = "DEFAULT", className }: SpinnerProps) {
  let Component = tag;

  return (
    <Component className={cn("relative mx-auto flex flex-shrink-0", sizes[size], colors[color], className)}>
      <span
        className={cn(
