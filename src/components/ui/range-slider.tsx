...
export default function RangeSlider({ size = "DEFAULT", color = "DEFAULT", className, ...props }: RangeSliderProps) {
  return <Slider className={cn(classes.base, classes.size[size], classes.color[color], className)} {...props} />;
}
